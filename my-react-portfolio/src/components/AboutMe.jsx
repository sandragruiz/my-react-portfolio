...
const About = () => {
    return (
        <div id='about' name='about' className='w-full h-screen bg-[#75132f] text-gray-300'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                <div className='max-w-[1000px] w-full px4 grid grid-cols-2 gap-8'>
                    
                    <div className='sm:text-right pb-8 pl-4'>
                        <a href='#aboutme'><p className='text-4xl font-bold inline border-b-4 border-rose-200'>About Me</p></a>
                    </div>
